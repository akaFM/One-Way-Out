...
## User Interface Specification
 > First and foremost, our title screen will be formatted as such. When the player inputs the keyword "inventory," the system will simply output a list of the player's current items (at the start of the game, this will simply output "you have nothing"). In all cases except for the title screen and viewing inventory, the user accesses seperate "screens" primarily when navigating through rooms. In order to do this, they must use keyworks "north," "south," "east," and "west" (example). You can find the room layout of our game here. Each of the numbers in the 2D array correspond to a seperate dialogue prompt, which describe the player's current surroundings. While we have not fully produced the game dialogue, you can find an example of what to expect here. At the end of the game, the user will be met with a congratulatory prompt (something simple like "congratulations, you won"), which will most likely display how many steps they took in total as well as their remaining HP. 
...
> * The first layout is the [title](https://media.discordapp.net/attachments/816244007143211048/1206801982078066768/IMG_8992.jpg?ex=65dd54ed&is=65cadfed&hm=eea047bcbd5a1c62dc0ac3ee5fd0c9dd0d1cc895f5bdb60a046c592de084e929&=&format=webp&width=770&height=1028) screen. This layout is immediately visible to all users upon running the executable. It will be a simple welcome, and will prompt the user to select a difficulty to start the game.
> * The second layout is the [inventory](https://media.discordapp.net/attachments/816244007143211048/1206801989783126016/IMG_8991.jpg?ex=65dd54ef&is=65cadfef&hm=5b063c1e25cce77f3bd8a934175481ca61e312d425e1bde201e39d330664d0e5&=&format=webp&width=770&height=1028) screen. This layout is visible to the user when they input the keyword "inventory" after getting past the title screen. It displays the current items in the player's inventory- at the start of the game, it will simply output "you have nothing." In addition, it will likely output the amount of time, steps, and/or HP that the player has remaining (these factors are dependent on the difficulty chosen when presented with the title screen).
> * The third layout is the [help](https://media.discordapp.net/attachments/816244007143211048/1206801996829564958/IMG_8990.jpg?ex=65dd54f1&is=65cadff1&hm=a83375e3efe9f5a8b0feba6b0c9b1d1e44feb97d03efecb38108ea9cbbbc15ef&=&format=webp&width=770&height=1028) screen. This layout is visible to the user when they input the word "help" after getting past the title screen. It displays a list of commands that the user can input in order to receive a viable output, in addition to example(s) of how such commands are used. The central commands of our program are "north," "south," "east," and "west," since they allow for the user to develop context, and hence, they will be listed first.
> * The final layout is the [general](https://media.discordapp.net/attachments/816244007143211048/1206802004274585661/IMG_8989.jpg?ex=65dd54f3&is=65cadff3&hm=7b031b4eaef25071c4d9e95711d4ed1e1e643215f0a6a0f5a65ef0fdd5348989&=&format=webp&width=770&height=1028) screen. These screens take up a vast majority of the game. Upon navigating from one room to another, the user is prompted with a preset description of the newly-entered room, which will contain information regarding the contents of the room as well as where the player can navigate thereafter (ex: "there is a door in front of you," "there is a can of beans on the floor"). "Spawning" in the first room (immediately after satisfying the title screen) will also greet the user with this same prompt.
