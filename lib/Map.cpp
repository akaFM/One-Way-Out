...
void Map::initializeGameMap(){
    ...
    vector<Items> roomNineInventory;
    ...
    gameMap[3][1] = new Room("Janitor Closet", "Nothing too special, just a bunch of mops and janitorial equipment. Maybe something in here could be useful. You can head north back into the main hallway.", true);
    gameMap[1][0] = new Room("Locker Room", "The floor is all wet. Some of the lockers are wide open. You can head south, back to the pool area, when you're ready.", true);
    ...
    gameMap[0][1] = new Room("Meat Locker", "It's freezing in here. The stench of expired poultry floods your nostrils. You immediately feel compelled to leave via the door to your east, but maybe you'll do some searching first.", true);
